...
describe('Analytics Service', () => {
  ...
  describe('trackAIUsage', () => {
    ...
    it('handles localStorage errors gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Failed to store AI usage data:', expect.any(Error));
  ...
  describe('clearAnalyticsData', () => {
    ...
    it('handles localStorage errors', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Failed to clear analytics data:', expect.any(Error));
