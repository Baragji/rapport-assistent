...
describe('AIClient', () => {
  ...
  describe('constructor', () => {
    ...
    it('should log error when API key is missing', () => {
      ...
      expect(client).toBeInstanceOf(AIClient);
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('OpenAI API key is missing'));
  ...
  describe('generateContentStream', () => {
    ...
    it('should handle streaming errors', async () => {
      ...
      await expect(aiClient.generateContentStream('Test prompt', onStream)).rejects.toThrow(
        AIError
      );
  ...
  describe('AIError class', () => {
    ...
    it('should create an AIError with custom values', () => {
      ...
      const error = new AIError('Test error', AIErrorType.RATE_LIMIT, true, originalError);
